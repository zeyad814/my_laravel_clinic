                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                        <span class="user-icon">
                            <img src="{{ asset('upload/users') }}/{{auth()->user()->image}}" alt="" />
                        </span>
                ...
                <ul id="accordion-menu">
                    ...
                    <li>
                        <a href="{{ route('admin.pages.majors') }}" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-diagram-3"></span><span class="mtext">majors</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.pages.doctors') }}" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-person-circle"></span><span class="mtext">doctors</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.pages.booking') }}" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-table"></span><span class="mtext">Booking</span>
                        </a>
                    </li>
                    <li>
